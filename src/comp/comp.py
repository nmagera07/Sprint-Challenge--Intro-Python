...
c = [human.name for human in humans if any(string in human.name[0] for string in ["C", "D", "E", "F", "G"])]
print(c)
...
f = [human.name + ", " + str(human.age) for human in humans if human.age >= 27 and human.age <= 32]
print(f)
...
g = [human.name.upper() + str(human.age + 5) for human in humans]
print(g)
